...
public class Canvas extends JComponent implements ActionListener, KeyListener {
	...
	Icon redSquare = new ImageIcon("images/redSquare.png");
	...
	// for KeyListener
	  ...
	  public void keyReleased(KeyEvent e) {
	    ...
	    selectedObject.setVelocity(selectedObject.getVelocity()+1);
	  }
	  
	  public void setDefaultGameObject(GameObject gameObject) {
